      ...
      [
        ...
        _c("div", [
          _c("div", { staticClass: "row m-0" }, [
            ...
            _vm._v(" "),
            _c("div", { staticClass: "col-md-3 pr-0 pl-0" }, [
              _c(
                "select",
                {
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.produto_vencimento_id,
                      expression: "produto_vencimento_id"
                    }
                  ],
                  ref: "inputProdutosVencimento",
                  staticClass: "form-control selectpicker",
                  attrs: {
                    "data-style": "btn-secondary",
                    disabled: _vm.produtosVencimento.length == 0,
                    "data-live-search": "true",
                    name: "inputProdutosVencimento",
                    id: "inputProdutosVencimento"
                  },
                  on: {
                    change: function($event) {
                      var $$selectedVal = Array.prototype.filter
                      ...
                      _vm.produto_vencimento_id = $event.target.multiple
                        ? $$selectedVal
                        : $$selectedVal[0]
                    }
                  }
                ...
                [
                  _c("option", { attrs: { selected: "", value: "false" } }, [
                    _vm._v(" Produto Substituído ")
                  ]),
                  _vm._v(" "),
                  _vm._l(_vm.produtosVencimento, function(
                    produtoVencimento,
                    index
                  ) {
                    return _c(
                      "option",
                      { key: index, domProps: { value: produtoVencimento.id } },
                      [
                        _vm._v(
                          _vm._s(produtoVencimento.produto.produto_desc_red)
                        )
                      ]
                    )
                  })
...
module.exports = __webpack_require__(/*! /mnt/7EDAA7EFDAA7A1BF/Desenvolvimento/Web/golden-frota/resources/js/osservico.js */"./resources/js/osservico.js");
