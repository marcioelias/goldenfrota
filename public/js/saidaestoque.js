...
var saida_estoque = __webpack_require__(166);
...
if (Component.options.functional) {console.error("[vue-loader] SaidaEstoqueItemsComponent.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6641ea46", Component.options)
  } else {
    hotAPI.reload("data-v-6641ea46", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    props: [
    //'produtosData',
    'oldData', 'estoques', 'oldEstoqueId', 'estoqueError'],
    data: function data() {
        return {
            editing: false,
            editingIndex: false,
    ...
    mounted: function mounted() {
        ...
        console.log(this.errors.estoqueId);
        console.log(this.estoqueError);
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-6641ea46", module.exports)
  }
}
